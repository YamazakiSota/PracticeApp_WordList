...
#ifndef WORDLIST_SWIFT_H
#define WORDLIST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WordList",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8WordList17AddViewController")
@interface AddViewController : UIViewController
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified englishTextField;
@property (nonatomic, strong) IBOutlet UITextField * _Null_unspecified japaneseTextField;
- (void)viewDidLoad;
- (IBAction)saveWord;
...
SWIFT_CLASS("_TtC8WordList11AppDelegate")
...
SWIFT_CLASS("_TtC8WordList20FinishViewController")
...
SWIFT_CLASS("_TtC8WordList17ListTableViewCell")
@interface ListTableViewCell : UITableViewCell
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified englishLabel;
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified japaneseLabel;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC8WordList23ListTableViewController")
...
SWIFT_CLASS("_TtC8WordList22QuestionViewController")
...
SWIFT_CLASS("_TtC8WordList13SceneDelegate")
...
SWIFT_CLASS("_TtC8WordList14ViewController")
@interface ViewController : UIViewController
- (IBAction)backWithSender:(UIStoryboardSegue * _Nonnull)sender;
